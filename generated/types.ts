...
export type GetActivitiesQuery = {
  ...
  activities: Array<{
    ...
    content: string
    createdAt: string
    board: { __typename?: 'Board'; id: string; title: string; description: string }
    persona: {
      __typename?: 'Persona'
      id: number
      screenName: string
    ...
    privilege: { __typename?: 'Privilege'; deleteSelf: boolean }
    threads: Array<{
      __typename?: 'Thread'
      id: string
      postId: string
      content: string
      createdAt: string
      board: { __typename?: 'Board'; id: string; title: string }
      persona: {
        __typename?: 'Persona'
        id: number
        screenName: string
...
export type GetBoardQuery = {
  ...
  board: {
    ...
    posts: Array<{
      ...
      createdAt: string
      board: { __typename?: 'Board'; id: string; description: string; title: string }
      persona: {
        __typename?: 'Persona'
        id: number
        screenName: string
...
export type SearchQuery = {
  __typename?: 'Query'
  search: Array<{ __typename?: 'SearchResult'; kind: string; id: string; title: string }>
}
...
export type GetFollowingBoardQuery = {
  __typename?: 'Query'
  getFollowingBoard: Array<{
    __typename?: 'FollowingBoard'
    board: { __typename?: 'Board'; title: string; id: string }
  }>
}
...
export type CreateBoardMutation = {
  __typename?: 'Mutation'
  createBoard: { __typename?: 'Board'; id: string }
}
...
export type CreatePersonaMutation = {
  __typename?: 'Mutation'
  createPersona: { __typename?: 'Persona'; name: string; screenName: string }
}
...
export type CreateReplyMutation = {
  __typename?: 'Mutation'
  createReply: { __typename?: 'Reply'; id: string }
}
...
export type CreateThreadMutation = {
  __typename?: 'Mutation'
  createThread: { __typename?: 'Thread'; id: string }
}
...
export type SetTypingStateOnBoardMutation = {
  __typename?: 'Mutation'
  setTypingStateOnBoard: { __typename?: 'Post'; id: string }
}
...
export type CreateFollowingBoardMutation = {
  __typename?: 'Mutation'
  createFollowingBoard: { __typename?: 'FollowingBoard'; id: string }
}
...
export type UnfollowBoardMutation = {
  __typename?: 'Mutation'
  unfollowBoard: { __typename?: 'FollowingBoard'; id: string }
}
...
export type CreateThirdPartyApiKeyMutation = {
  __typename?: 'Mutation'
  createThirdPartyAPIKey: { __typename?: 'ThirdPartyAPIKey'; token: string }
}
...
export type CreateDirectMessageMutation = {
  __typename?: 'Mutation'
  createDirectMessage: { __typename?: 'DirectMessage'; id: string }
}
...
export const CreateReplyDocument = gql`
  mutation createReply($content: String!, $personaId: Int!, $threadId: String!) {
    createReply(content: $content, contentType: TEXT, personaId: $personaId, threadId: $threadId) {
      id
    }
  }
`
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    ...
    ): Promise<GetActivitiesQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetActivitiesQuery>(GetActivitiesDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'getActivities',
    ...
    getBoard(
      ...
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<GetBoardQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetBoardQuery>(GetBoardDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'getBoard',
    ...
    getFollowingBoard(
      variables: GetFollowingBoardQueryVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<GetFollowingBoardQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetFollowingBoardQuery>(GetFollowingBoardDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'getFollowingBoard',
    ...
    createPersona(
      variables: CreatePersonaMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<CreatePersonaMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<CreatePersonaMutation>(CreatePersonaDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'createPersona',
    ...
    createReply(
      ...
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<CreateReplyMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<CreateReplyMutation>(CreateReplyDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'createReply',
    ...
    createThread(
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<CreateThreadMutation>(CreateThreadDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'createThread',
    ...
    putAttachedImage(
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<PutAttachedImageMutation>(PutAttachedImageDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'putAttachedImage',
    ...
    setPersonaIcon(
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<SetPersonaIconMutation>(SetPersonaIconDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'setPersonaIcon',
    ...
    setTypingStateOnBoard(
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<SetTypingStateOnBoardMutation>(SetTypingStateOnBoardDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'setTypingStateOnBoard',
    ...
    createFollowingBoard(
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<CreateFollowingBoardMutation>(CreateFollowingBoardDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'createFollowingBoard',
    ...
    unfollowBoard(
      variables: UnfollowBoardMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<UnfollowBoardMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<UnfollowBoardMutation>(UnfollowBoardDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'unfollowBoard',
    ...
    createThirdPartyAPIKey(
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<CreateThirdPartyApiKeyMutation>(
            CreateThirdPartyApiKeyDocument,
            variables,
    ...
    createDirectMessage(
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<CreateDirectMessageMutation>(CreateDirectMessageDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'createDirectMessage',
...
export function getSdkWithHooks(
  ...
  return {
    ...
    useGetActivities(
      key: SWRKeyInterface,
      variables?: GetActivitiesQueryVariables,
      config?: SWRConfigInterface<GetActivitiesQuery, ClientError>
    ) {
      return useSWR<GetActivitiesQuery, ClientError>(
        key,
        () => sdk.getActivities(variables),
        config
      )
    },
    useGetBoard(
      key: SWRKeyInterface,
      variables: GetBoardQueryVariables,
      config?: SWRConfigInterface<GetBoardQuery, ClientError>
    ) {
    ...
    useGetMe(
      key: SWRKeyInterface,
      variables?: GetMeQueryVariables,
      config?: SWRConfigInterface<GetMeQuery, ClientError>
    ) {
    ...
    useGetPost(
      key: SWRKeyInterface,
      variables: GetPostQueryVariables,
      config?: SWRConfigInterface<GetPostQuery, ClientError>
    ) {
    ...
    useSearch(
      key: SWRKeyInterface,
      variables: SearchQueryVariables,
      config?: SWRConfigInterface<SearchQuery, ClientError>
    ) {
      return useSWR<SearchQuery, ClientError>(key, () => sdk.Search(variables), config)
    },
    useGetFollowingBoard(
      key: SWRKeyInterface,
      variables: GetFollowingBoardQueryVariables,
      config?: SWRConfigInterface<GetFollowingBoardQuery, ClientError>
    ) {
      return useSWR<GetFollowingBoardQuery, ClientError>(
        key,
        () => sdk.getFollowingBoard(variables),
        config
      )
    },
  }
