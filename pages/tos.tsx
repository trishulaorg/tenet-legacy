...
**Coton is operated by Trishula LLC. We, Trishula LLC, is a Japanese company. Following terms of service in Japanese will be applied to all users regardless where users live in.**

# 利用規約

**利用規約**

この利用規約（以下，「本規約」といいます。）は，合同会社Trishula（以下，「当社」といいます。）がこのウェブサイト上で提供するサービス（以下，「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。
...
2. ユーザーは、本サービス上で他ユーザーに向けて有料コンテンツの設定及びその他方法で利益を得ることが可能です、ユーザーが本サービスで得た利益の一部を弊社の手数料として徴収します。
...
11. 以下を目的とし，または目的とすると当社が判断する行為
    ...
    2. 他のユーザーに対する嫌がらせや誹謗中傷を目的とする行為
    3. 当社，本サービスの他のユーザー，または第三者に不利益，損害または不快感を与えることを目的とする行為
    4. その他本サービスが予定している利用目的と異なる目的で本サービスを利用する行為
