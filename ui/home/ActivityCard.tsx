...
export const ActivityCard: React.FC<ActivityCardProps> = observer(({ post }) => {
  ...
  const content = (
    <motion.div
      ...
      animate={{ y: 0, opacity: 0.9, borderRadius: 20 }}
      className="select-none drop-shadow-lg max-w-2xl p-4 bg-contentbg dark:bg-contentbg-dark mb-5 opacity-95 text-med dark:text-med-dark transition-colors duration-350 cursor-pointer"
    >
